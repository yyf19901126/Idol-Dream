...
const ITEMS=[
  ...
  {id:'signalTower',cls:'A',rarity:3,name:'信号增幅塔',desc:'远台魅力 +13% · 存在感 +10% · 手速 +4%；移速 −6%',price:52, mods:{dmgRanged:.13,range:.10,aspd:.04,speed:-.06}},
  /* 状态·应援共鸣流 */
  ...
  {id:'catalyst',   cls:'A',rarity:3,name:'化学催化剂',desc:'应援共鸣 +15% · 手速 +4%；移速 −4% · 暴击率 −6%',price:52, mods:{dmgElem:.15,aspd:.04,speed:-.04,crit:-.06}},
  /* 召唤·义体流 */
  ...
  /* 暴击·冷艳流 */
  {id:'cueCard',    cls:'A',rarity:1,name:'台词卡套',  desc:'暴击率 +6% · 玄学 +6%；心态上限 −6',price:28, mods:{crit:.06,luck:.06,maxhp:-6}},
  {id:'flashMoment',cls:'A',rarity:2,name:'闪光时刻',  desc:'暴击率 +8% · 远台魅力 +6%；心态上限 −10',price:38, mods:{crit:.08,dmgRanged:.06,maxhp:-10}},
  {id:'fatalLine',  cls:'A',rarity:3,name:'致命独白',  desc:'暴击率 +11% · 手速 +4%；心态上限 −12 · 抗压 −1',price:50, mods:{crit:.11,aspd:.04,maxhp:-12,armor:-1}},
  /* 攻速·连发流 */
  ...
  {id:'overclockHR',cls:'A',rarity:3,name:'超频心率',  desc:'手速 +13% · 暴击率 +4%；魅力 −5% · 抗压 −1',price:50, mods:{aspd:.13,crit:.04,dmg:-.05,armor:-1}},
  /* 坦克·续航流 */
  ...
  {id:'bizSuit',    cls:'A',rarity:2,name:'商务套装',  desc:'打赏 +12% · 玄学 +6% · 恰饭 +3；移速 −4%',price:38, mods:{gold:.12,luck:.06,harvest:3,speed:-.04}},
  {id:'capital',    cls:'A',rarity:3,name:'资本运作',  desc:'打赏 +15% · 经验(人气) +10%；魅力 −6% · 抗压 −1',price:50, mods:{gold:.15,xp:.10,dmg:-.06,armor:-1}},
  /* 敏捷·走位流 */
  {id:'runners',    cls:'A',rarity:1,name:'轻量跑鞋',  desc:'移速 +7% · 临场(闪避) +4%；抗压 −1',price:28, mods:{speed:.07,dodge:.04,armor:-1}},
  {id:'cape',       cls:'A',rarity:2,name:'风衣披风',  desc:'移速 +9% · 临场(闪避) +6% · 吸引力 +40；抗压 −1',price:38, mods:{speed:.09,dodge:.06,armor:-1}, hidden:{pickup:40}},
  {id:'afterimage', cls:'A',rarity:3,name:'残影步法',  desc:'移速 +12% · 临场(闪避) +8%；抗压 −2 · 近台 −6%',price:50, mods:{speed:.12,dodge:.08,armor:-2,dmgMelee:-.06}},
  /* 玄学·全能流 */
  {id:'luckCharm',  cls:'A',rarity:1,name:'锦鲤挂件',  desc:'玄学 +10% · 恰饭 +2（纯增益，便宜）',price:24, mods:{luck:.10,harvest:2}},
  {id:'allTonic',   cls:'A',rarity:2,name:'全能补剂',  desc:'魅力 +5% · 手速 +4% · 暴击率 +3%；移速 −3%',price:40, mods:{dmg:.05,aspd:.04,crit:.03,speed:-.03}},
  {id:'chosen',     cls:'A',rarity:3,name:'天选之人',  desc:'玄学 +20% · 暴击率 +5% · 打赏 +8%；移速 −5%',price:50, mods:{luck:.20,crit:.05,gold:.08,speed:-.05}},
];
...
const ETYPES={      /* baseHP/baseDMG=波1基准；spawn 时按 §5.1 数量优先公式随波缩放（单体很缓） */
  ...
  heifen: {name:'黑粉头目',  hp:290,spd:40, dmg:12, gold:30,xp:18,r:16, elite:1},
  leping: {name:'毒舌乐评人',hp:380,spd:34, dmg:10, gold:35,xp:20,r:15, elite:1, shooter:1},
  /* ---- BOSS 体系（§07 §6）：boss=B1出道Boss；bCritic/bRival/bMatrix/bCensor/bDiva = mini-boss/无尽轮换 ---- */
  boss:   {name:'讨债的诊所老板',  hp:40000,spd:46,dmg:15,gold:200,xp:100,r:24, boss:1, kind:'debt',   tex:'boss'},
  bCritic:{name:'毒舌乐评人·终场Live',hp:20000,spd:42,dmg:13,gold:200,xp:100,r:24, boss:1, kind:'critic', tex:'leping'},
  bRival: {name:'对家当红顶流',    hp:24000,spd:52,dmg:12,gold:200,xp:100,r:24, boss:1, kind:'rival',  tex:'duijia'},
  bMatrix:{name:'流量黑洞·营销号矩阵',hp:18000,spd:38,dmg:10,gold:200,xp:100,r:26, boss:1, kind:'matrix', tex:'shuijun'},
  bCensor:{name:'平台审查官AI',    hp:22000,spd:40,dmg:14,gold:200,xp:100,r:24, boss:1, kind:'censor', tex:'heifen'},
  bDiva:  {name:'过气初代天后',    hp:28000,spd:44,dmg:15,gold:240,xp:120,r:24, boss:1, kind:'diva',   tex:'boss'},
};
